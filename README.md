...
- `eda_sensores.ipynb`: Notebook com a análise exploratória e tratamento dos dados.
- `iot_agricola_raw.csv`: Dataset sintético gerado para simular falhas de hardware no campo.